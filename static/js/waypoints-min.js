!function (t) {
  ...
  t.fn.counterUp = function (e) {
    ...
    return this.each(function () {
      var e = t(this), r = n, o = function () {
        var t = [], n = r.time / r.delay, o = e.text(), i = /[0-9]+,[0-9]+/.test(o);
        o = o.replace(/,/g, "");
        for (var l = (/^[0-9]+$/.test(o), /^[0-9]+\.[0-9]+$/.test(o)), u = l ? (o.split(".")[1] || []).length : 0, s = n; s >= 1; s--) {
          var a = parseInt(o / n * s);
          if (l && (a = parseFloat(o / n * s).toFixed(u)), i)for (; /(\d+)(\d{3})/.test(a.toString());)a = a.toString().replace(/(\d+)(\d{3})/, "$1,$2");
          t.unshift(a)
        }
  ...
  function () {
    ...
    !function (t, e) {
      return "function" == typeof define && define.amd ? define("waypoints", ["../../../../moban2091/js/jquery"], function (n) {
        return e(n, t)
      }) : e(t.jQuery, t)
    }(this, function (n, r) {
      ...
      }, n[w].settings = {resizeThrottle: 100, scrollThrottle: 30}, o.load(function () {
        return n[w]("refresh")
      })
    })
  }.call(this),
