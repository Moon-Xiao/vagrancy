<template>
  <div style="background-color: rgb(245, 245, 245); padding-top: 20px">
    ...
    <div class="country-content">
      <paginate-list certain-list="region" select="name intro main-photo" class-name="store-list-left-container">
        <template slot="list-item" scope="item">
          ...
          <div class="product-description">
            ...
            <img class="product-img" :src="'/'+item.value['main-photo'].path"/>
            <div class="product-des-right">
              <div class="product-des-middle">
                <p class="pro-des-title">{{item.value.name}}</p>
              </div>
              <div class="product-des-top">
                <span>{{item.value.intro}}</span>
              </div>
              <b-btn variant="link" class="details-btn" to="/destinations/city">查看详情</b-btn>
            </div>
          </div>
        </template>
      </paginate-list>
