<template>
  <div id="messageBoard">
    <div class="header">
      ...
      <textarea placeholder="你想说点啥"></textarea>
      <button class="btn btn-warning" v-model="leaveMessage">留言</button>
    </div>
    <div class="body">
        ...
        message: [
          {
            ...
            info: 'sfdghjdghdsjhmgftgdgfbgnbbvc'
          },
          {
            name: 'moon-xiao',
            img: '/static/images/person/sina.png',
            time: '2017-08-11 01:22:22',
            info: 'sfdghjdghdsjhmgfdhgfsmfnmd'
          },
          {
            name: 'moon-xiao',
            img: '/static/images/person/QQspace.png',
            time: '2017-08-11 01:22:22',
            info: 'sfdghjdghdsjhmgfdhgfsmfnmd'
          }
        ]
...
<style>
  ...
  #messageBoard .item .item-info {
    display: flex;
    margin-left: 1rem;
  }

  #messageBoard .item .item-info .info-img {
    width: 3.4rem;
    height: 3.4rem;
    border-radius: 50%;
  ...
  #messageBoard .item .item-content {
    width: 90%;
    height: 50px;
    text-align: left;
    overflow: hidden;
  ...
  #messageBoard .item .item-info .info-detail {
    padding: 0.5rem;
    margin: 0 auto;
  }

  #messageBoard .item .item-info .info-detail p {
    text-align: center;
  }
  ...
  #messageBoard .item .item-operation:hover {
    color: #1baede;
  }
</style>
